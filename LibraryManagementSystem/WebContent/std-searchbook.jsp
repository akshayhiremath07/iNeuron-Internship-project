    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <form action="./stdtest/searchbook" method="post">
        ...
        <h2>"Books are the plane, and the train, and the road. They are the destination, and the journey. They are home." - Anna Quindlen</h2>
    </div>
    <!-- Bootstrap JS -->
